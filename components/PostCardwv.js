...
function PostCardwv() {
  return (
    <div className='flex flex-col justify-center shadow-2xl bg-gray-600 pb-10 p-x-2 rounded-[30px]'>
      ...
      <img
        ...
        className=' inline-block max-w-4xl max-h-4xl rounded-[60px] p-10'
        alt=''></img>
